...
project = 'dandyrow.archlinux Ansible collection'
copyright = 'Daniel Lowry'

title = 'dandyrow.archlinux Ansible Collection Documentation'
html_short_title = 'dandyrow.archlinux Documentation'
